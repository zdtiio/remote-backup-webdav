...
# 运行第一个同步任务
bash /home/remote_backup/sh/task1_remote_backup.sh
if [ $? -ne 0 ]; then
...
# 运行第二个同步任务
bash /home/remote_backup/sh/task2_remote_backup.sh
if [ $? -ne 0 ]; then
...
# 运行第三个同步任务
bash /home/remote_backup/sh/task3_remote_backup.sh
if [ $? -ne 0 ]; then
...
# 运行第四个同步任务
bash /home/remote_backup/sh/task4_remote_backup.sh
if [ $? -ne 0 ]; then
